...
| [ZenOps](https://github.com/opsre/ZenOps)  | ![](https://img.shields.io/github/stars/opsre/ZenOps?color=f2f08d&logo=Undertale&logoColor=eb4630) |          🧘 通过钉钉、飞书、企微智能机器人用自然语言查询运维资源的工具         |
| [deviops](https://github.com/opsre/deviops)  | ![](https://img.shields.io/github/stars/opsre/deviops?color=f2f08d&logo=Undertale&logoColor=eb4630) |        一个基于 Go + vue3 框架开发的企业级运维自动化平台        |
